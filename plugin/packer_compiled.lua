...
_G.packer_plugins = {
  Alduin = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/Alduin",
  ...
  nvim = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/nvim",
  ...
  ["telescope-repo.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/telescope-repo.nvim",
